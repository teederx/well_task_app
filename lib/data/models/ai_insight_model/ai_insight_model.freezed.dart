...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double productivityScore,  String summary,  List<String> recommendations,  DateTime generatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AIInsightModel() when $default != null:
return $default(_that.productivityScore,_that.summary,_that.recommendations,_that.generatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double productivityScore,  String summary,  List<String> recommendations,  DateTime generatedAt)  $default,) {final _that = this;
switch (_that) {
case _AIInsightModel():
return $default(_that.productivityScore,_that.summary,_that.recommendations,_that.generatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double productivityScore,  String summary,  List<String> recommendations,  DateTime generatedAt)?  $default,) {final _that = this;
switch (_that) {
case _AIInsightModel() when $default != null:
return $default(_that.productivityScore,_that.summary,_that.recommendations,_that.generatedAt);case _:
  return null;
